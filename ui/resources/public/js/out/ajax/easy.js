...
var G__12496 = format;
var G__12496__$1 = (((G__12496 instanceof cljs.core.Keyword))?G__12496.fqn:null);
switch (G__12496__$1) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__12500_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__12500_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__12501){
var map__12502 = p__12501;
var map__12502__$1 = (((((!((map__12502 == null))))?(((((map__12502.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12502.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12502):map__12502);
var handler = cljs.core.get.call(null,map__12502__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__12502__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__12502__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__12504){
var vec__12505 = p__12504;
var ok = cljs.core.nth.call(null,vec__12505,(0),null);
var result = cljs.core.nth.call(null,vec__12505,(1),null);
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__12508){
...
var method = cljs.core.get.call(null,map__12509__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__12509__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__12509__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__12509__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__12509__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
