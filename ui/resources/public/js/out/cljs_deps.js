...
goog.addDependency("../re_com/validate.js", ['re_com.validate'], ['re_com.util', 'goog.string', 'reagent.core', 'cljs.core', 'reagent.impl.template', 'cljs_time.core', 'clojure.set', 'reagent.impl.component']);
...
goog.addDependency("../re_com/popover.js", ['re_com.popover'], ['re_com.util', 'reagent.ratom', 're_com.box', 'reagent.core', 'cljs.core', 're_com.close_button', 're_com.validate', 'clojure.string', 'reagent.dom']);
...
goog.addDependency("../re_com/dropdown.js", ['re_com.dropdown'], ['re_com.util', 're_com.box', 'reagent.core', 'cljs.core', 're_com.validate', 'clojure.string', 'reagent.dom']);
...
goog.addDependency("../re_frisk/utils.js", ['re_frisk.utils'], ['goog.string', 'cljs.core', 'goog.string.format', 'clojure.string']);
goog.addDependency("../re_frisk/ui/components/colors.js", ['re_frisk.ui.components.colors'], ['cljs.core']);
goog.addDependency("../re_frisk/subs_graph.js", ['re_frisk.subs_graph'], ['cljs.core', 're_frisk.ui.components.colors']);
goog.addDependency("../re_frisk/ui/subs.js", ['re_frisk.ui.subs'], ['reagent.core', 'cljs.core', 're_frisk.subs_graph']);
goog.addDependency("../re_frisk/ui/components/components.js", ['re_frisk.ui.components.components'], ['cljs.core']);
goog.addDependency("../re_frisk/filter/filter_matcher.js", ['re_frisk.filter.filter_matcher'], ['cljs.core', 'clojure.string']);
...
goog.addDependency("../re_frisk/filter/filter_parser.js", ['re_frisk.filter.filter_parser'], ['cljs.tools.reader', 'cljs.core', 'cljs.tools.reader.reader_types', 'clojure.string']);
goog.addDependency("../re_frisk/ui/components/frisk.js", ['re_frisk.ui.components.frisk'], ['re_com.core', 'cljs.core', 'clojure.set', 're_frisk.filter.filter_matcher', 're_frisk.ui.components.components', 're_frisk.filter.filter_parser']);
goog.addDependency("../re_frisk/ui/trace.js", ['re_frisk.ui.trace'], ['cljs.core', 're_frisk.utils', 're_frisk.ui.components.components', 're_frisk.ui.components.colors']);
goog.addDependency("../re_frisk/ui/events.js", ['re_frisk.ui.events'], ['re_com.core', 'reagent.core', 'cljs.core', 're_frisk.utils', 're_frisk.ui.subs', 're_frisk.ui.components.components', 're_frisk.ui.components.frisk', 'clojure.string', 're_frisk.ui.trace', 'reagent.dom']);
...
goog.addDependency("../re_frisk/db.js", ['re_frisk.db'], ['re_frame.trace', 'reagent.core', 'cljs.core']);
goog.addDependency("../re_frisk/ui/timeline.js", ['re_frisk.ui.timeline'], ['cljs.core', 're_frisk.utils', 're_frisk.ui.components.components']);
goog.addDependency("../re_frisk/ui/components/github.js", ['re_frisk.ui.components.github'], ['cljs.core']);
goog.addDependency("../re_frisk/ui/components/splits.js", ['re_frisk.ui.components.splits'], ['re_com.util', 're_com.box', 'reagent.core', 'cljs.core']);
goog.addDependency("../re_frisk/ui/views.js", ['re_frisk.ui.views'], ['re_frisk.ui.timeline', 're_com.core', 'reagent.core', 'cljs.core', 're_frisk.utils', 're_frisk.ui.components.github', 're_frisk.ui.events', 're_frisk.ui.components.splits', 're_frisk.ui.subs', 're_frisk.ui.components.components', 're_frisk.ui.components.frisk']);
goog.addDependency("../re_frisk/ui/components/drag.js", ['re_frisk.ui.components.drag'], ['reagent.core', 'cljs.core', 'goog.events.EventType', 'goog.events']);
goog.addDependency("../re_frisk/ui/style.js", ['re_frisk.ui.style'], ['cljs.core', 're_frisk.utils']);
goog.addDependency("../re_frisk/ui/external_hml.js", ['re_frisk.ui.external_hml'], ['cljs.core']);
goog.addDependency("../re_frisk/ui.js", ['re_frisk.ui'], ['re_frisk.db', 're_frisk.ui.views', 'cljs.core', 're_frisk.utils', 're_frisk.ui.components.drag', 're_frisk.subs_graph', 're_frisk.ui.style', 're_frisk.ui.external_hml', 'reagent.dom']);
...
goog.addDependency("../re_frisk/diff/diff.js", ['re_frisk.diff.diff'], ['cljs.core', 'clojure.set']);
goog.addDependency("../re_frisk/trace.js", ['re_frisk.trace'], ['re_frame.interop', 'reagent.impl.util', 're_frame.trace', 'reagent.ratom', 're_frisk.diff.diff', 'cljs.core', 're_frisk.utils', 'goog.object', 'reagent.impl.batching', 'clojure.string', 're_frame.db']);
...
goog.addDependency("../re_frisk/core.js", ['re_frisk.core'], ['re_frame.interop', 're_frisk.trace', 're_frisk.db', 're_frisk.ui', 're_frame.trace', 're_frisk.diff.diff', 'reagent.core', 'cljs.core', 're_frisk.utils', 're_frisk.subs_graph', 're_frame.subs', 're_frame.db', 're_frame.core']);
...
goog.addDependency("../ui/db.js", ['ui.db'], ['reagent.core', 'cljs.core', 'clojure.string', 're_frame.core']);
...
goog.addDependency("../zframes/routing.js", ['zframes.routing'], ['cljs.core', 'zframes.window_location', 'clojure.set', 'route_map.core', 'clojure.string', 're_frame.core']);
goog.addDependency("../zframes/redirect.js", ['zframes.redirect'], ['cljs.core', 'zframes.window_location', 'clojure.string', 'zframes.routing', 're_frame.core']);
goog.addDependency("../ui/pages.js", ['ui.pages'], ['reagent.core', 'cljs.core', 're_frame.core']);
...
goog.addDependency("../ui/patient/model.js", ['ui.patient.model'], ['ajax.core', 'cljs.core', 'clojure.string', 're_frame.core', 'day8.re_frame.http_fx']);
goog.addDependency("../zframes/debounce.js", ['zframes.debounce'], ['cljs.core', 're_frame.core']);
...
goog.addDependency("../ui/styles.js", ['ui.styles'], ['cljs.core', 'garden.core']);
goog.addDependency("../ui/patient/core.js", ['ui.patient.core'], ['zframes.redirect', 'ui.pages', 'ui.patient.model', 'reagent.core', 'cljs.core', 'zframes.debounce', 'clojure.string', 'ui.styles', 're_frame.core']);
goog.addDependency("../cljs/spec/gen/alpha.js", ['cljs.spec.gen.alpha'], ['goog.Uri', 'cljs.core']);
goog.addDependency("../ui/layout.js", ['ui.layout'], ['reagent.core', 'cljs.core', 'ui.styles', 're_frame.core', 'garden.core']);
...
goog.addDependency("../dev/start.js", ['dev.start'], ['dev.reload', 'ui.core', 'cljs.core', 'devtools.core']);
