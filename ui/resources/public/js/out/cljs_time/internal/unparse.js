...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__13738 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,(function (p1__13737_SHARP_){
return cljs.core.subs.call(null,p1__13737_SHARP_,(0),(3));
}),G__13738);
} else {
return G__13738;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__13747){
var vec__13748 = p__13747;
var t = cljs.core.nth.call(null,vec__13748,(0),null);
var pattern = cljs.core.nth.call(null,vec__13748,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__13751 = pattern;
switch (G__13751) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13751)].join('')));
...
var G__13761 = key;
var G__13761__$1 = (((G__13761 instanceof cljs.core.Keyword))?G__13761.fqn:null);
switch (G__13761__$1) {
case "millis":
return (function (p1__13753_SHARP_){
return p1__13753_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__13754_SHARP_){
return p1__13754_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__13755_SHARP_){
return p1__13755_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__13756_SHARP_){
return p1__13756_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__13757_SHARP_){
return p1__13757_SHARP_.getHours();
});

break;
case "day":
return (function (p1__13758_SHARP_){
return p1__13758_SHARP_.getDate();
});

break;
case "month":
return (function (p1__13759_SHARP_){
return p1__13759_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__13760_SHARP_){
return p1__13760_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13761__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__13763){
...
var key = first__13766;
var args = seq__13765__$1;
var G__13767 = key;
...
break;
case "ordinal-suffix":
var vec__13768 = syntax_list.call(null,(i - (1)));
var k = cljs.core.nth.call(null,vec__13768,(0),null);
...
var d = value;
var G__13775 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__13776 = G__13775;
...
var unparser = first__13778;
var more = seq__13777__$1;
var s = "";
var d__$1 = d;
var G__13775__$1 = G__13775;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__13785 = G__13775__$1;
...
var unparser__$1 = first__13787;
var more__$1 = seq__13786__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__13788 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__13788,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__13788,(1),null);
var G__13791 = d__$3;
var G__13792 = more__$1;
var G__13793 = s__$3;
d__$1 = G__13791;
G__13775__$1 = G__13792;
s__$1 = G__13793;
continue;
}
break;
