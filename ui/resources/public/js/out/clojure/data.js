...
return cljs.core.reduce.call(null,(function (result,p__10963){
...
var vec__10967 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__10967,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__10967,(1),null);
var ab = cljs.core.nth.call(null,vec__10967,(2),null);
...
return (function (){var G__10976 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10976__$1)].join('')));
