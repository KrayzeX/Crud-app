...
var reader = (function (){var or__4185__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4185__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return (128);
...
var line = cljs.core.get.call(null,map__8948__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__8948__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e8947){var _e = e8947;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___8950 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___8950)){
var seen_errors_8951 = temp__5733__auto___8950;
if(cljs.core.truth_(seen_errors_8951.has(self))){
} else {
seen_errors_8951.add(self);

var temp__5735__auto___8952 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___8952)){
var sense_8953 = temp__5735__auto___8952;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_8953)].join(''));
} else {
}
}
} else {
