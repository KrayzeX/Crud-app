...
return [(function (){var pred__7997 = cljs.core.instance_QMARK_;
var expr__7998 = reactive_val;
if(cljs.core.truth_(pred__7997.call(null,reagent.ratom.RAtom,expr__7998))){
return "ra";
} else {
if(cljs.core.truth_(pred__7997.call(null,reagent.ratom.RCursor,expr__7998))){
return "rc";
} else {
if(cljs.core.truth_(pred__7997.call(null,reagent.ratom.Reaction,expr__7998))){
return "rx";
} else {
if(cljs.core.truth_(pred__7997.call(null,reagent.ratom.Track,expr__7998))){
return "tr";
} else {
return "other";
}
