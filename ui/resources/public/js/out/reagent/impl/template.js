...
var G__7853 = o;
goog.object.set(G__7853,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__7854__delegate = function (args){
...
var G__7857 = o;
goog.object.set(G__7857,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var args = null;
if (arguments.length > 0) {
var G__7859__i = 0, G__7859__a = new Array(arguments.length -  0);
while (G__7859__i < G__7859__a.length) {G__7859__a[G__7859__i] = arguments[G__7859__i + 0]; ++G__7859__i;}
...
var G__7861 = props;
var G__7861__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__7861,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__7861);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__7861__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4185__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__7862 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__7862,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__7862;
}
})(),id_class);
...
var G__7863 = (cljs.core.count.call(null,argv) - first_child);
switch (G__7863) {
case (0):
...
var vec__7865 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__7865,(0),null);
var id = cljs.core.nth.call(null,vec__7865,(1),null);
var className = cljs.core.nth.call(null,vec__7865,(2),null);
...
var temp__5739__auto___7868 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___7868 == null)){
} else {
var key_7869 = temp__5739__auto___7868;
(jsprops.key = key_7869);
}
...
var temp__5739__auto___7870 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5739__auto___7870 == null)){
} else {
var key_7871 = temp__5739__auto___7870;
(jsprops.key = key_7871);
}
...
var temp__5739__auto___7872 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5739__auto___7872 == null)){
} else {
var key_7873 = temp__5739__auto___7872;
(jsprops.key = key_7873);
}
...
var temp__5739__auto___7874 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___7874 == null)){
} else {
var key_7875 = temp__5739__auto___7874;
(jsprops.key = key_7875);
}
...
var temp__5739__auto___7876 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___7876 == null)){
} else {
var key_7877 = temp__5739__auto___7876;
(jsprops.key = key_7877);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__7878_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__7878_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__7879 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__7879,(0),null);
var derefed = cljs.core.nth.call(null,vec__7879,(1),null);
...
break;
default:
var G__7884 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__7885 = compiler;
v = G__7884;
compiler = G__7885;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template7889 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template7889 = (function (opts,id,fn_to_element,meta7890){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template7889.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_7891,meta7890__$1){
var self__ = this;
var _7891__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template7889(self__.opts,self__.id,self__.fn_to_element,meta7890__$1));
}));

(reagent.impl.template.t_reagent$impl$template7889.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_7891){
var self__ = this;
var _7891__$1 = this;
return self__.meta7890;
}));

(reagent.impl.template.t_reagent$impl$template7889.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template7889.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template7889.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template7889.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template7889.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta7890","meta7890",-1176286425,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template7889.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template7889.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template7889");

(reagent.impl.template.t_reagent$impl$template7889.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write.call(null,writer__4429__auto__,"reagent.impl.template/t_reagent$impl$template7889");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template7889.
 */
reagent.impl.template.__GT_t_reagent$impl$template7889 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template7889(opts__$1,id__$1,fn_to_element__$1,meta7890){
return (new reagent.impl.template.t_reagent$impl$template7889(opts__$1,id__$1,fn_to_element__$1,meta7890));
});

}

return (new reagent.impl.template.t_reagent$impl$template7889(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
